...
namespace params_automatic {
	...
	//static const double OffsetUltraSensor = 0.1; // respect to the baricenter of the drone

	static const double OffsetUltraSensor = -0.082; //respect to the robot legs
    ...
    static const double KpHold           = 0.4; //0.7;//0.5;//0.78; 
